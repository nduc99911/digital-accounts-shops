    ...
    <div className="grid gap-6">
        ...
        <div className="space-y-4">
          <div className="rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-5">
            ...
            <div className="grid gap-2">
              <QuickLink href="/god/products" label="➕ Thêm sản phẩm" />
              <QuickLink href="/god/orders" label="📋 Xem đơn hàng" />
              <QuickLink href="/god/settings/payment" label="💳 Cài đặt thanh toán" />
              <QuickLink href="/god/settings" label="⚙️ Cài đặt website" />
            </div>
          </div>
      ...
      <div className="rounded-xl bg-slate-900/60 p-5 ring-1 ring-white/10">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/god/orders" className="text-sm text-blue-400 hover:text-blue-300">
            Xem tất cả →
          </Link>
        </div>
