  ...
  return (
    <div className="grid gap-4">
      <div className="flex items-center justify-between">
        ...
        <Link href={`/god/products/${product.id}`} className="text-sm text-blue-400 hover:underline">
          ← Quay lại
        </Link>
      </div>
      ...
      <div className="rounded-lg bg-slate-900/60 p-5 shadow-sm ring-1 ring-white/10">
        ...
        <form action={`/api/god/products/${product.id}/stock`} method="post" className="grid gap-3">
          <textarea
